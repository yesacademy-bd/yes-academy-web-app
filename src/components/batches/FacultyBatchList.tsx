        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          {isHR && (
            <select
              ...
              className="w-full sm:w-48 px-3 py-2 text-sm text-gray-900 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
