                  ...
                  <tr key={r.id} className="hover:bg-gray-50">
                    ...
                    <td className="p-4 text-center space-x-2">
                      <button
                        ...
                        className={`inline-flex items-center justify-center p-2 rounded-lg transition-colors ${!r.email ? 'bg-gray-100 text-gray-400 cursor-not-allowed' : 'bg-blue-100 text-sky-500 hover:bg-blue-200 disabled:opacity-50'}`}
