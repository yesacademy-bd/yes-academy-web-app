                ...
                {mocks.map(m => (
                  <tr key={m.id} className="hover:bg-gray-50">
                    ...
                    <td className="p-4 text-center">
                      <a
                        href={`https://wa.me/${m.phone}?text=${encodeURIComponent(`Hello ${m.student_name}, this is a confirmation for your ${m.mock_type}. Your exam is scheduled on ${new Date(m.exam_date).toLocaleDateString()}. Fee: ৳${m.amount}, Paid: ৳${m.paid_amount || 0}, Due: ৳${m.due_amount}.`)}`}
                        target="_blank"
