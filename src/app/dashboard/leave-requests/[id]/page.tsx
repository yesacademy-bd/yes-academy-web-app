    ...
    <div className="space-y-6 max-w-4xl mx-auto pb-12">
      ...
      <div className="bg-white shadow-sm border border-gray-200 rounded-2xl overflow-hidden">
        ...
        <div className="flex flex-col divide-y divide-gray-200">
          <div className="flex">
            <div className="w-1/4 bg-gray-50 px-4 py-4 text-sm font-bold text-gray-700 border-r border-gray-200 flex items-center">Leave request</div>
            <div className="w-3/4 px-4 py-4 flex flex-wrap items-center gap-8">
              <span className={`text-sm font-medium ${req.leave_type === 'Days' ? 'text-gray-900 font-bold' : 'text-gray-500'}`}>☑ Days</span>
              <span className={`text-sm font-medium ${req.leave_type === 'Half Day' ? 'text-gray-900 font-bold' : 'text-gray-500'}`}>☑ Half Day</span>
              <span className={`text-sm font-medium ${req.leave_type === 'Hours' ? 'text-gray-900 font-bold' : 'text-gray-500'}`}>☑ Hours</span>
            </div>
          </div>
      ...
      <div className="bg-white shadow-sm border border-gray-200 rounded-2xl overflow-hidden">
        ...
        <div className="p-6">
          <div className="text-sm font-bold text-gray-900 bg-gray-100 px-4 py-2 rounded-lg inline-block border border-gray-200">
      ...
      <div className="bg-white shadow-sm border border-gray-200 rounded-2xl overflow-hidden">
        ...
        <div className="flex flex-col divide-y divide-gray-200">
          <div className="flex">
            <div className="w-1/3 md:w-1/4 bg-gray-100 px-4 py-4 text-sm font-bold text-gray-700 border-r border-gray-200">Employee signature</div>
      ...
      {isManagement && req.status === 'Pending' ? (
        ...
        <div className="bg-white shadow-sm border border-gray-200 rounded-2xl overflow-hidden mt-8 border-t-4 border-t-gray-800">
          <div className="bg-gray-800 px-6 py-3 border-b border-gray-200">
          ...
          <div className="bg-gray-800 px-6 py-3 border-y border-gray-200">
