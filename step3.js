...
export default function StudentDatabaseFilter({ batches }: { batches: any[] }) {
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md border border-gray-200 flex flex-col">
            <div className="p-4 border-b border-gray-200 flex justify-between items-center bg-gray-50 rounded-t-xl">
              ...
              <button onClick={() => {setSwitching(null); setRemarks(''); setTargetBatchId('');}} className="text-gray-400 hover:text-gray-700"><X className="w-5 h-5" /></button>
            </div>
            <div className="p-4 space-y-4">
              <div>
              ...
              <div className="pt-4 flex justify-end gap-3">
                <button onClick={() => {setSwitching(null); setRemarks(''); setTargetBatchId('');}} className="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50">Cancel</button>
